...
public class PilihGambarComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/wa.jpg"))); // NOI18N
        pCardLayout.add(jLabel5, "1");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ig.jpg"))); // NOI18N
        pCardLayout.add(jLabel2, "2");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fb.jpg"))); // NOI18N
        pCardLayout.add(jLabel3, "3");

        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -", "WA", "IG", "FB" }));
